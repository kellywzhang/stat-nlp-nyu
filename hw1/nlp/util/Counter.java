...
public class Counter<E> implements Serializable {
	 ...
	 * totalCount() instead). VOCABULARY SIZE (V)
	 */
	public int size() {
		return entries.size();
	}
	 ...
	 * totalCount > 0) ZERO VOCABULARY WORDS
	 */
	 ...
	 * from getCount(). CHECKS WHETHER WORD IS IN VOCABULARY
	 * 
	 * @param key
	 ...
	 * or zero if the key wasn't in the counter to begin with. REMOVE WORD FROM VOCAB
	 * 
	 * @param key
	 ...
	 * counter. GETS FREQUENCY COUNT OF WORD
	 * 
	 * @param key
	 * @return
	 */
	...
	// Increment counts with new counter
